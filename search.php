...
try {
    $pdo = connect();
    if ($pdo) {
        $req = "SELECT b.images, b.titre ,a.nom FROM books b join Auteur a on(b.auteur_id=a.id) join Genre g on b.genre_id=g.id where  b.titre like '%" . $_SESSION['name'] . "%' or a.nom like'%" . $_SESSION['name'] . "%' or g.nom like'%" . $_SESSION['name'] . "%'";
