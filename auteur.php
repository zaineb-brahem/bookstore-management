...
try {
    $pdo = connect();
    if ($pdo) {
        $req = "SELECT id, images, nom FROM  Auteur  ";
            ...
            <div class="row">
                <?php foreach ($lignes as $ligne) : ?>
                    <div class="col-lg-4 text-center mb-4">
                        <div class="card">
                            <img src="<?php echo $ligne['images']; ?>" alt="<?php echo $ligne['nom']; ?>" class="card-img-top">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $ligne['nom']; ?></h5>
                                <div class="form_element my-4">
                                    <a href="admin/detaila.php?id=<?php echo $ligne['id']; ?>" class="btn btn-info">Voir plus</a>
                                </div>
                            </div>
                        </div>
                    </div>
